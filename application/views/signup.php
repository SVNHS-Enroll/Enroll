        ...
        <div class="col-md-6">
            <form action="welcome/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" id="user" class="form-control" placeholder="enter username" style="width: 70%">
                </div>
                <div class="form-group">
                    <h6 style="font-family: GothicBold; font-size: 15px; font-weight: bolder; color: #2699FB">EMAIL</h6>
                    <input type="email" name="email" id="email" class="form-control" placeholder="enter email address" style="width: 70%">
                </div>
                <div class="form-group">
                    <h6 style="font-family: GothicBold; font-size: 15px; font-weight: bolder; color: #2699FB">PASSWORD</h6>
                    <input type="password" name="password" id="pass" class="form-control" placeholder="enter password" style="width: 70%">
                </div>
                <div class="form-group">
